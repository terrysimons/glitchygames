...
class PerformanceMonitor:
    ...
    def get_operation_stats(self, operation: str) -> PerformanceMetrics | None:
...
class MultiControllerPerformanceOptimizer:
    ...
    def optimize_system(self) -> dict[str, Any]:
        ...
        if any(
            results[key] > 0 for key in ["controllers_cleaned", "memory_cleaned", "cache_cleared"]
        ):
    ...
    def get_system_performance_stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "active_controllers": sum(
                1 for s in self.controller_selections.values() if s.is_active()
            ),
        }
