"""Simple working tests for Scenes module to achieve 100% coverage.
...
class TestScenesSimple100(unittest.TestCase):
    """Simple working tests for Scenes functionality to achieve 100% coverage."""
    ...
    def test_scene_left_mouse_button_down_event_simple(self):
        """Test Scene on_left_mouse_button_down_event method with simple approach."""
        scene = Scene()
