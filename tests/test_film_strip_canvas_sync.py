...
class TestFilmStripCanvasSync:
    ...
    def test_film_strip_shows_canvas_content(self):
        ...
        assert initial_pixels != updated_pixels, "Film strip should update when canvas content changes"
    ...
    def test_film_strip_frame_thumbnail_uses_canvas(self):
        ...
        thumbnail = self.film_strip.render_frame_thumbnail(frame, is_selected=True, is_hovered=False)
