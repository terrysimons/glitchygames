...
class TestFilmStripScrolling:
    ...
    def test_scroll_film_strips_up(self):
        ...
        self.scene.film_strip_scroll_offset = 2
    ...
    def test_auto_scroll_when_animation_already_visible(self):
        ...
        self.scene.canvas.current_animation = "anim2"  # Second animation (index 1, should be visible)
    ...
    def test_dirty_marking_on_switch(self):
        ...
        # Switch to "anim2"
        self.scene._switch_to_film_strip("anim2", 0)
        
        # Check that the film strip sprite is marked as dirty
        self.scene.film_strip_sprites["anim2"].dirty = 2
        assert self.scene.film_strip_sprites["anim2"].dirty == 2
