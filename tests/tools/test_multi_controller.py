"""Tests for multi-controller manager functionality and coverage."""
...
class TestMultiControllerManager:
    ...
    def test_controller_colors(self):
        ...
        assert expected_colors == self.manager.CONTROLLER_COLORS
...
class TestMultiControllerManagerCleanup:
    ...
    def test_cleanup_inactive_controllers(self):
        ...
        from glitchygames.bitmappy.multi_controller_manager import ControllerInfo
