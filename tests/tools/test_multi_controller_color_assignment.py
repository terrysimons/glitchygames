...
class TestShoulderButtonFunctionality:
    ...
    def test_shoulder_button_scrolling_integration(self, mocker):
        ...
        mock_film_strip.update_scroll_for_frame = mocker.Mock()
...
class TestSelectionBoxColorMatching:
    ...
    def test_selection_box_color_priority(self):
        ...
        for selection in selections:
            ...
            elif isinstance(selection['type'], str) and selection['type'].startswith('controller'):
