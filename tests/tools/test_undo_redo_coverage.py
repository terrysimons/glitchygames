"""Extended tests for UndoRedoManager to increase coverage.

Covers uncovered lines including Operation validation, frame-specific undo/redo,
film strip operations, cross-area operations, controller operations,
frame selection operations, and callback-missing branches.
"""
...
class TestOperationPostInit:
    """Test Operation dataclass __post_init__ validation."""
