...
class _UndoRedoFilmStripCoordinator:
...
class _UndoRedoFrameManager:
    """Mock frame manager for undo/redo expected behavior tests."""
...
class _UndoRedoAnimatedSprite:
    """Mock animated sprite for undo/redo expected behavior tests."""
    ...
    def __init__(self):
        ...
        self.frame_manager = _UndoRedoFrameManager()
...
class _UndoRedoCanvasInterface:
    """Mock canvas interface for undo/redo expected behavior tests."""
...
class _UndoRedoCanvas:
    """Mock canvas for undo/redo expected behavior tests."""

    def __init__(self, scene):
        self.current_animation = 'strip_1'
        self.current_frame = 0
        self.canvas_interface = _UndoRedoCanvasInterface(scene=scene)
        self.animated_sprite = _UndoRedoAnimatedSprite()
        self._scene = scene
...
class _UndoRedoMockScene:
    """Mock scene for undo/redo expected behavior tests."""

    def __init__(self):
        self._applying_undo_redo = False
        self.canvas = _UndoRedoCanvas(scene=self)
        ...
        self.film_strip_coordinator = _UndoRedoFilmStripCoordinator()
...
class TestExpectedUndoRedoBehavior:
    ...
    def test_scenario_2_mixed_single_and_drag_operations(self, mock_scene):
        ...
        drag1_pixels = [
            (10, 10, (255, 0, 0), (100, 100, 100)),
            (11, 11, (255, 0, 0), (110, 110, 110)),
        ]
        drag2_pixels = [
            (20, 20, (255, 0, 0), (200, 200, 200)),
            (21, 21, (255, 0, 0), (210, 210, 210)),
        ]
    ...
    def test_scenario_3_multiple_frames_edit_undo_redo(self, mock_scene):
        ...
        for frame_num in [1, 2, 3, 4]:
            ...
            mock_scene.edit_pixel(
                ...
                frame_num * 5,
                (255, 0, 0),
                (frame_num * 60, frame_num * 60, frame_num * 60),
            )
    ...
    def test_scenario_4_multiple_strips_edit_undo_redo(self, mock_scene):
        ...
        for frame_num in range(1, 5):
            ...
            mock_scene.edit_pixel(
                ...
                frame_num * 3,
                (255, 0, 0),
                (frame_num * 40, frame_num * 40, frame_num * 40),
            )
        ...
        for frame_num in range(1, 5):
            ...
            mock_scene.edit_pixel(
                ...
                frame_num * 7,
                (0, 0, 255),
                (frame_num * 80, frame_num * 80, frame_num * 80),
            )
