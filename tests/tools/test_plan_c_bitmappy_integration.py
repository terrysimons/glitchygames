...
class TestBitmappyPlanCIntegration:
    ...
    def setup_mocks(self, mocker):
        ...
        self.mock_scene.multi_controller_manager.get_controller_info.return_value = (
            self.mock_controller_info
        )
    ...
    def test_controller_registration_on_trigger(self):
        ...
        assert (
            self.mode_switcher.get_controller_mode(self.controller_id) == ControllerMode.FILM_STRIP
        )
    ...
    def test_visual_indicator_updates_on_mode_switch(self):
        ...
        self.mock_scene._update_controller_visual_indicator_for_mode(self.controller_id, new_mode)
    ...
    def test_trigger_debouncing(self):
        ...
        self.mode_switcher.handle_trigger_input(self.controller_id, 0.0, 0.0, current_time + 0.15)
    ...
    def test_controller_hotplug_support(self):
        ...
        assert (
            self.mode_switcher.get_controller_mode(new_controller_id) == ControllerMode.FILM_STRIP
        )
    ...
    def test_mode_switching_edge_cases(self):
        ...
        # Release R2
        self.mode_switcher.handle_trigger_input(self.controller_id, 0.0, 0.0, current_time + 0.05)
        ...
        # Release L2
        self.mode_switcher.handle_trigger_input(self.controller_id, 0.0, 0.0, current_time + 0.25)
