...
class TestSpriteHasPerPixelAlpha:
    ...
    def test_no_animations_attribute(self):
        ...
        assert _sprite_has_per_pixel_alpha(FakeSprite()) is False
    ...
    def test_has_transparent_pixel(self):
        ...
        assert _sprite_has_per_pixel_alpha(FakeSprite()) is True
...
class TestCompositeFramesWithAlpha:
    ...
    def test_single_frame(self):
        ...
        class FakeFrame:
            ...
            def get_pixel_data(self):
                return [(100, 100, 100, 255)] * 4

        result = _composite_frames_with_alpha([FakeFrame()])
        assert len(result) == 4
