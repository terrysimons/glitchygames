...
Targets areas NOT covered by test_canvas_interfaces_coverage.py:
- AnimatedCanvasInterface.get_pixel_at with animated sprite frames
- AnimatedCanvasInterface.set_pixel_at full path (non-skip_drag_ops)
...
- AnimatedCanvasInterface._collect_pixel_change
- AnimatedCanvasInterface._should_track_color_change with canvas_operation_tracker
- StaticCanvasInterface.set_pixel_at with RGB to RGBA conversion
- AnimatedCanvasRenderer methods
"""
