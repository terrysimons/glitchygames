...
class TestCanvasInterfacesCoverage(unittest.TestCase):
    ...
    def test_static_canvas_interface_comprehensive(self):
        """Test comprehensive StaticCanvasInterface functionality."""
        ...
        mock_canvas_sprite.pixels_across = 2
        mock_canvas_sprite.pixels_tall = 2
        mock_canvas_sprite.dirty_pixels = [False, False, False, False]
        mock_canvas_sprite.dirty = 0
        mock_canvas_sprite.image = Mock()
    ...
    def test_static_sprite_serializer(self):
        """Test StaticSpriteSerializer functionality."""
        from unittest.mock import Mock
        ...
        try:
            serializer.load("test.toml")
        except Exception:
            pass  # Expected to not be fully implemented

    def test_static_canvas_renderer(self):
        """Test StaticCanvasRenderer functionality."""
        ...
        mock_canvas_sprite.pixels_across = 2
        mock_canvas_sprite.pixels_tall = 2
        mock_canvas_sprite.pixel_width = 10
        mock_canvas_sprite.pixel_height = 10
        mock_canvas_sprite.background_color = (0, 0, 0)
        mock_canvas_sprite.border_thickness = 1
        mock_canvas_sprite.dirty_pixels = [False, False, False, False]
        mock_canvas_sprite.image = Mock()
        mock_canvas_sprite.image.fill = Mock()
        # Ensure the fill method is properly mocked
        ...
        with patch.object(renderer, "force_redraw") as mock_force_redraw:
            mock_surface = Mock()
            mock_force_redraw.return_value = mock_surface
    ...
    def test_animated_canvas_interface_comprehensive(self):
        """Test comprehensive AnimatedCanvasInterface functionality."""
        from unittest.mock import Mock
        ...
        mock_canvas_sprite.pixels = [(100, 100, 100), (200, 200, 200)]
        mock_canvas_sprite.pixels_across = 2
        mock_canvas_sprite.pixels_tall = 1
        mock_canvas_sprite.dirty_pixels = [False, False]
        mock_canvas_sprite.dirty = 0
        mock_canvas_sprite.current_animation = "walk"
        mock_canvas_sprite.current_frame = 0
        mock_canvas_sprite.image = Mock()
        mock_canvas_sprite.image.fill = Mock()
        # Ensure the fill method is properly mocked
        mock_canvas_sprite.image.fill.return_value = None
    ...
    def test_animated_canvas_interface_without_animated_sprite(self):
        """Test AnimatedCanvasInterface without animated sprite."""
        from unittest.mock import Mock

        from glitchygames.tools.canvas_interfaces import AnimatedCanvasInterface

        # Create canvas sprite without animated sprite
        mock_canvas_sprite = Mock()
        # Explicitly set animated_sprite to None to avoid hasattr issues
        mock_canvas_sprite.animated_sprite = None
        mock_canvas_sprite.pixels = [(255, 0, 0), (0, 255, 0)]
        mock_canvas_sprite.pixels_across = 2
        mock_canvas_sprite.pixels_tall = 1
        mock_canvas_sprite.dirty_pixels = [False, False]
        ...
        # Test initialization without animated sprite
    ...
    def test_animated_canvas_interface_empty_animations(self):
        """Test AnimatedCanvasInterface with empty animations."""
        from unittest.mock import Mock
    ...
    def test_animated_canvas_interface_no_animation_order(self):
        """Test AnimatedCanvasInterface without animation order."""
        from unittest.mock import Mock
    ...
    def test_animated_sprite_serializer(self):
        """Test AnimatedSpriteSerializer functionality."""
        from unittest.mock import Mock
    ...
    def test_animated_canvas_renderer(self):
        """Test AnimatedCanvasRenderer functionality."""
        from unittest.mock import Mock, patch
        ...
        mock_canvas_sprite.current_animation = "walk"
        mock_canvas_sprite.current_frame = 0
        mock_canvas_sprite.width = 20
        mock_canvas_sprite.height = 10
        mock_canvas_sprite.pixels_across = 2
        mock_canvas_sprite.pixels_tall = 1
        mock_canvas_sprite.pixel_width = 10
        mock_canvas_sprite.pixel_height = 10
    ...
    def test_animated_canvas_renderer_fallback(self):
        """Test AnimatedCanvasRenderer fallback scenarios."""
        from unittest.mock import Mock, patch
        ...
        # The implementation checks hasattr but doesn't check if the value is None
        mock_canvas_sprite.width = 20
        mock_canvas_sprite.height = 10
        mock_canvas_sprite.pixels_across = 2
        mock_canvas_sprite.pixels_tall = 1
    ...
    def test_animated_canvas_renderer_invalid_frame(self):
        """Test AnimatedCanvasRenderer with invalid frame."""
        from unittest.mock import Mock, patch
    ...
    def test_animated_canvas_renderer_frame_without_get_pixel_data(self):
        """Test AnimatedCanvasRenderer with frame without get_pixel_data method."""
        from unittest.mock import Mock, patch
    ...
    def test_animated_canvas_renderer_fallback_case(self):
        """Test AnimatedCanvasRenderer fallback case (covers lines 440-449)."""
        from unittest.mock import Mock, patch
    ...
    def test_animated_canvas_interface_pixel_operations_with_animated_sprite(self):
        """Test pixel operations with animated sprite."""
        from unittest.mock import Mock
    ...
    def test_animated_canvas_interface_surface_cache_clearing(self):
        """Test surface cache clearing in animated canvas interface."""
        from unittest.mock import Mock
    ...
    def test_animated_canvas_interface_out_of_bounds(self):
        """Test animated canvas interface with out-of-bounds coordinates."""
        from unittest.mock import Mock
        ...
        assert mock_canvas_sprite.dirty == original_dirty  # Should not change
