"""Simple tests for missing Scenes functionality.

This module tests specific missing lines to achieve 80%+ coverage.
Focuses on simple, targeted tests using the centralized MockFactory.
"""
...
class TestScenesSimpleMissingCoverage(unittest.TestCase):
    """Test coverage for specific missing Scenes functionality."""
