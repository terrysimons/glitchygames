...
class TestBallBounceConfiguration:
    ...
    def test_custom_bounce_settings(self):
        ...
        assert ball1.bounce_top_bottom
        assert ball1.bounce_left_right

        ball2 = BallSprite(bounce_top_bottom=True, bounce_left_right=False)
        assert ball2.bounce_top_bottom
        assert not ball2.bounce_left_right

        ball3 = BallSprite(bounce_top_bottom=False, bounce_left_right=True)
        assert not ball3.bounce_top_bottom
        assert ball3.bounce_left_right

        ball4 = BallSprite(bounce_top_bottom=False, bounce_left_right=False)
        assert not ball4.bounce_top_bottom
        assert not ball4.bounce_left_right
    ...
    def test_no_bounce_behavior(self):
        ...
        assert ball.speed.y == original_speed_y
