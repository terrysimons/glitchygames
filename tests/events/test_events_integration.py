...
class TestEventIntegration:
    ...
    def test_audio_event_through_engine(self, mock_pygame_patches, mock_managers, mocker):
    ...
    def test_controller_event_through_engine(self, mock_pygame_patches, mock_managers, mocker):
    ...
    def test_unhandled_event_falls_back_to_stubs(self, mock_pygame_patches, mock_managers, mocker):
    ...
    def test_engine_event_handlers_are_configured(self, mock_pygame_patches, mock_managers, mocker):
