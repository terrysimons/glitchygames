...
class TestMultiLineTextBoxCursorBoundaries(unittest.TestCase):
    """Test MultiLineTextBox cursor behavior at boundaries."""

    def setUp(self):
        """Set up test fixtures with real pygame fonts for accurate measurements."""
    ...
    def _create_textbox(self, width=TEST_TEXTBOX_WIDTH_MEDIUM, text=""):
    ...
    def _simulate_key_press(self, textbox, key, unicode_char=""):
    ...
    def _simulate_mouse_click(self, textbox, x_offset, y_offset):
    ...
    def test_cursor_reaches_last_character_single_line(self):
    ...
    def test_cursor_reaches_last_character_multi_line(self):
    ...
    def test_cursor_at_end_after_explicit_newline(self):
    ...
    def test_cursor_at_end_of_wrapped_line(self):
    ...
    def test_right_arrow_at_end_of_line_moves_to_next_line(self):
        ...
        with patch("glitchygames.ui.FontManager.get_font") as mock_get_font:
            ...
            self._simulate_key_press(textbox, pygame.K_RIGHT)
    ...
    def test_left_arrow_at_start_of_line_moves_to_prev_line_end(self):
        ...
        with patch("glitchygames.ui.FontManager.get_font") as mock_get_font:
            ...
            self._simulate_key_press(textbox, pygame.K_LEFT)
    ...
    def test_right_arrow_at_absolute_end(self):
    ...
    def test_left_arrow_at_absolute_start(self):
    ...
    def test_down_arrow_preserves_column_when_possible(self):
        ...
        with patch("glitchygames.ui.FontManager.get_font") as mock_get_font:
            ...
            textbox.cursor_pos = 3
            self._simulate_key_press(textbox, pygame.K_DOWN)
    ...
    def test_up_arrow_preserves_column_when_possible(self):
        ...
        with patch("glitchygames.ui.FontManager.get_font") as mock_get_font:
            ...
            self._simulate_key_press(textbox, pygame.K_UP)
    ...
    def test_mouse_click_at_exact_character_boundary(self):
        ...
        with patch("glitchygames.ui.FontManager.get_font") as mock_get_font:
            ...
            self._simulate_mouse_click(textbox, TEST_PADDING, TEST_PADDING)
    ...
    def test_mouse_click_past_end_of_line(self):
        ...
        with patch("glitchygames.ui.FontManager.get_font") as mock_get_font:
            ...
            self._simulate_mouse_click(textbox, TEST_TEXTBOX_WIDTH_WIDE - 20, TEST_PADDING + 5)
    ...
    def test_mouse_click_on_wrapped_second_line(self):
        ...
        with patch("glitchygames.ui.FontManager.get_font") as mock_get_font:
            ...
            self._simulate_mouse_click(textbox, 50, TEST_PADDING + line_height + 5)
    ...
    def test_mouse_click_on_empty_line(self):
    ...
    def test_cursor_with_all_same_characters(self):
    ...
    def test_cursor_with_repeated_patterns(self):
    ...
    def test_cursor_with_spaces_only(self):
    ...
    def test_explicit_newline_followed_by_long_line(self):
    ...
    def test_multiple_explicit_newlines_in_sequence(self):
    ...
    def test_wrapped_line_ending_with_explicit_newline(self):
    ...
    def test_backspace_at_end_of_line(self):
        ...
        with patch("glitchygames.ui.FontManager.get_font") as mock_get_font:
            ...
            self._simulate_key_press(textbox, pygame.K_BACKSPACE)
    ...
    def test_backspace_at_start_of_line_joins_lines(self):
    ...
    def test_delete_at_end_of_line_joins_lines(self):
        ...
        with patch("glitchygames.ui.FontManager.get_font") as mock_get_font:
            ...
            textbox.cursor_pos = 2
            self._simulate_key_press(textbox, pygame.K_DELETE)
    ...
    def test_delete_at_very_end_of_text(self):
    ...
    def test_insert_at_end_of_line(self):
        ...
        with patch("glitchygames.ui.FontManager.get_font") as mock_get_font:
            ...
            self._simulate_key_press(textbox, 0, "X")
    ...
    def test_insert_at_very_end_of_text(self):
        ...
        with patch("glitchygames.ui.FontManager.get_font") as mock_get_font:
            ...
            # Simulate text input via key event with unicode
            self._simulate_key_press(textbox, 0, "!")
    ...
    def test_insert_newline_in_middle_of_line(self):
        ...
        with patch("glitchygames.ui.FontManager.get_font") as mock_get_font:
            ...
            textbox.cursor_pos = 2
            self._simulate_key_press(textbox, pygame.K_RETURN)
    ...
    def test_selection_to_end_of_line(self):
        ...
        with patch("glitchygames.ui.FontManager.get_font") as mock_get_font:
            ...
            with patch("glitchygames.ui.pygame.key.get_mods", return_value=pygame.KMOD_SHIFT):
                for _ in range(3):
                    mock_event = Mock()
    ...
    def test_selection_from_end_of_line_backwards(self):
    ...
    def test_selection_across_wrapped_line_boundary(self):
